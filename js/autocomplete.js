...
{
    const recipeInput = document.getElementById("dbRecipe");
    const recipeSuggestions = recipeNames.map(recipe => recipe.name); // Extract recipe names
    autocomplete(recipeInput, recipeSuggestions);
});
